...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["nathan@mergington.edu", "rachel@mergington.edu"]
    },
    "Soccer Club": {
    ...
    "Science Olympiad": {
        "description": "Train for science competitions and build experimental projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "mia@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare arguments and compete in public speaking tournaments",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
